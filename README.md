# The Genetic Basis of Migratory Behavior in Pacific Cod (_Gadus macrocephalus_) Workflow:  assembly, analysis, and visualization/graphing

## Assembly
Assembly and basic analyses follow the [WGSfqs-to-genolikelihoods](https://github.com/letimm/WGSfqs-to-genolikelihoods) pipeline. The run was initialized with [GMAC-TAG_config.txt](https://github.com/letimm/pcaific-cod_lcWGS_residency/blob/main/scripts/GMAC-TAG_config.txt).

------------------------------------------Updating sablefish to reflect pcod workflow
